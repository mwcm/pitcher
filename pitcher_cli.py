...
@click.option('--output-filter-type',         type=click.Choice(OUTPUT_FILTER_TYPES), default='MoogLP', case_sensitive=False)
@click.option('--moog-output-filter-cutoff',  type=int, default='10000', case_sensitive=False)
def cli_wrapper(
        st,
        input_file,
        output_file,
